...
# 上料点物料级别激光传感器（仅控制面板/状态栏使用，画布不渲染）
MATERIAL_LASER_SENSORS = {
    'feed2_2_stone':  {'name': 'S-feed2_2(石粉)',  'feed_point': 'feed2_2'},
    'feed2_2_10mm':  {'name': 'S-feed2_2(10mm)',  'feed_point': 'feed2_2'},
    'feed2_2_20mm':  {'name': 'S-feed2_2(20mm)',  'feed_point': 'feed2_2'},
    'feed3_stone':   {'name': 'S-feed3(石粉)',     'feed_point': 'feed3'},
    'feed3_10mm':    {'name': 'S-feed3(10mm)',     'feed_point': 'feed3'},
}
